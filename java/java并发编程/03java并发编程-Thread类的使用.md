...
![线程状态](http://ww1.sinaimg.cn/large/006nK6pBgy1g665go5f72j30ox0eajv1.jpg)

blocked、waiting、time waiting统称为阻塞状态，这里将线程的状态和Java中的方法调用联系起来，所以将waiting和time waiting两个状态分离出来。
...
![线程变化](http://ww1.sinaimg.cn/large/006nK6pBgy1g665i95lpyj30nm0fhgqk.jpg)
